...
PROVENANCE_PATTERNS = [
    ...
    (r"\bgenerated by\b", "generated by"),
    (r"\bmade by ai\b", "made by ai"),
    (r"\bide\b", "ide"),
]
...
def validate():
    ...
    add(checks, "No AI or tooling provenance terms in publishable docs", not provenance_hits, ", ".join(provenance_hits))
